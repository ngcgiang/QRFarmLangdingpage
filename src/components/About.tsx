      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                      QRFarm đang tiên phong trong tương lai của nông nghiệp bằng cách tích hợp công nghệ hàng đầu mã QR, trí tuệ nhân tạo, IoT, xác minh blockchain và mô hình đồng hành mùa vụ để tạo ra một hệ sinh thái số toàn diện cho chuỗi cung ứng thực phẩm trong nước nói riêng và toàn cầu nói chúng.
          </p>
        </div>
